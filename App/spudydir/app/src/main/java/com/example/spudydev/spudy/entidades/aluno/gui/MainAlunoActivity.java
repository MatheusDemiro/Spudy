...
public class MainAlunoActivity extends AppCompatActivity
    ...
    //Instância da classe MenuLateralDAO
    private MenuLateralDAO dadosMenuLateralDAO = new MenuLateralDAO();
    //ArrayList
    private ArrayList<HashMap<String, String>> listaTurmaAluno = new ArrayList<>();
    //ListView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dadosMenuLateralDAO.setNomeEmailView(navigationView, AcessoFirebase.getFirebaseAutenticacao().getCurrentUser());
        ...
        lvTurmaAluno.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String array[] = ((TextView) view.findViewById(R.id.txtCodigoTurma)).getText().toString().split(":");
               abrirTelaChat(array[1].substring(1));
            }
        });
    }
    ...
    public void getTurmasAluno(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot dataSnapshotChild: turmas){
            if (!dataSnapshotChild.getKey().equals("SENTINELA")){
                montandoDicionarioTurmasAluno(dataSnapshot, dataSnapshotChild);
            }
        }
    }
    //Método que monta o HashMap do SimpleAdapter
    public void montandoDicionarioTurmasAluno(DataSnapshot dataSnapshot, DataSnapshot dataSnapshotChild) {
        ...
        dicionarioTurmasAluno.put("codigoTurma", "Código turma: " + codigoTurma);
    ...
    public void abrirTelaChat(String codigoTurma){
        Intent intent = new Intent(getApplicationContext(), ChatActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString("codigoTurma", codigoTurma);
