...
public class MainProfessorActivity extends AppCompatActivity
    ...
    private ArrayList<HashMap<String, String>> listaTurmasMinistradas = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dadosMenuLateralDAO.setNomeEmailView(navigationView, FirebaseAuth.getInstance().getCurrentUser());
    ...
    private void montandoDicionarioTurmasProfessor(DataSnapshot dataSnapshot, DataSnapshot dataSnapshotChild) {
        ...
        dicionarioTurmasProfessor.put("codigoTurma", "Código turma: " + codigoTurma);
