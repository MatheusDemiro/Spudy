...
public class AlterarEnderecoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtAlteraRua = findViewById(R.id.edtAlterarEnderecoPerfil);
    ...
    public void setarCampos(final Endereco endereco){
        edtAlteraRua.setText(endereco.getEndereco());
    ...
    public Endereco criaEndereco(){
        ...
        if (edtAlteraRua.getText().toString().trim().length() == 0){
            ...
            endereco.setEndereco(edtAlteraRua.getText().toString());
        }
    ...
    //alterando o endereço diretamente no banco de dados
    public void alteraEndereco(){
        Endereco endereco = criaEndereco();
        AcessoFirebase.getFirebase().child("endereco").child(AcessoFirebase.getUidUsuario()).setValue(endereco);
    }
