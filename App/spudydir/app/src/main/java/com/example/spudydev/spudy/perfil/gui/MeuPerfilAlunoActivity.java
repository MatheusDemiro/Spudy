...
import com.example.spudydev.spudy.usuario.gui.AlterarEmailActivity;
import com.example.spudydev.spudy.pessoa.gui.AlterarEnderecoActivity;
import com.example.spudydev.spudy.usuario.gui.AlterarInstituicaoActivity;
import com.example.spudydev.spudy.pessoa.gui.AlterarNomeActivity;
import com.example.spudydev.spudy.usuario.gui.AlterarSenhaActivity;
    ...
    public void informacoesPerfilAluno() {
        ...
        AcessoFirebase.getFirebase().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //formando a string de endereço
                String enderecoPerfil = endereco.getEstado()+" - "+endereco.getCidade()+" - "+endereco.getEndereco();

                tvEnderecoPerfilAluno.setText(enderecoPerfil);
