...
import com.example.spudydev.spudy.activity.LoginActivity;
...
public class MeuPerfilProfessorActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nomeConsulta = (TextView) findViewById(R.id.txt_conta_professor_nomeAlterar);
        emailConsulta = (TextView) findViewById(R.id.txt_conta_professor_emailAlterar);
        dataNascimentoConsulta = (TextView) findViewById(R.id.txt_conta_professor_dataNascimentoAlterar);
        instituicaoConsulta = (TextView) findViewById(R.id.txt_conta_professor_instituicaoAlterar);
        btnInformacao = (Button) findViewById(R.id.btn_informacao_perfil_professor);
        //fim instancias
