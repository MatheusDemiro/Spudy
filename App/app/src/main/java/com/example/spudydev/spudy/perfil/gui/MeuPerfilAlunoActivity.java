...
public class MeuPerfilAlunoActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nomeConsulta =  findViewById(R.id.txt_conta_aluno_nomeAlterar);
        emailConsulta = findViewById(R.id.txt_conta_aluno_emailAlterar);
        dataNascimentoConsulta = findViewById(R.id.txt_conta_aluno_dataNascimentoAlterar);
        instituicaoConsulta = findViewById(R.id.txt_conta_aluno_instituicaoAlterar);
        btnInformacao = findViewById(R.id.btn_informacao_perfil_aluno);
        //fim instancias
