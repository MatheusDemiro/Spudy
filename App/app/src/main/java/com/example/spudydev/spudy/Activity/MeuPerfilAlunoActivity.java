...
public class MeuPerfilAlunoActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nomeConsulta = (TextView) findViewById(R.id.txt_conta_aluno_nomeAlterar);
        emailConsulta = (TextView) findViewById(R.id.txt_conta_aluno_emailAlterar);
        dataNascimentoConsulta = (TextView) findViewById(R.id.txt_conta_aluno_dataNascimentoAlterar);
        instituicaoConsulta = (TextView) findViewById(R.id.txt_conta_aluno_instituicaoAlterar);
